        ...
        <div className="lr-width-container">
          ...
          <div className="mb-8">
            ...
            <p className="lr-body-l text-muted-foreground max-w-2xl">
              The fastest way to waste time is to talk about the wrong cases. Tell us what your firm is looking for, what your team can handle, and what a worthwhile handoff looks like.
            </p>
          </div>

  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all focus-visible:outline-none focus-visible:bg-[#FFD900] focus-visible:text-[#0b0c0c] focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-0 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        "outline-stable": "border-2 border-primary bg-white text-primary hover:bg-white/90 hover:text-primary rounded-none lr-focus",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 rounded-none lr-focus",
        ghost: "hover:bg-accent hover:text-accent-foreground rounded-none lr-focus",
        link: "text-primary underline-offset-4 hover:underline lr-focus",
      },
      size: {
